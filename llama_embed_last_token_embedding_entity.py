...
if __name__ == '__main__':
    ...
    relation_lis = []
    #relation_lis = load_chatgpt_relation_file('./entity_description/FB15k-237-entity_simple_description.csv')
    relation_lis = load_chatgpt_relation_file('./entity_description/entity_description.csv')
    ...
    for i in range(iter):
        ...
        if rela_dic != []:
            ...
            #input_ids.append(len(inputs.input_ids[0]))
            #print(mean(input_ids))
    ...
    np.save(os.path.join(args.embed_save_path, 'entity_embedding_llama_avg.npy'), embed_lis)
