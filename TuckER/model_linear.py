...
class TuckER(torch.nn.Module):
    def __init__(self, d, d1, d2, **kwargs):
        ...
        self.triple_embedding = torch.tensor(np.load("../../KGE_chatgpt/embed/triple_embedding_llama_avg.npy", allow_pickle=True))
    ...
    def forward(self, e1_idx, r_idx, triple_matrix):
        e1 = self.E(e1_idx)
        x = self.bn0(e1)
